...
public class MasterServer extends Server<CopyOnWriteArrayList<Server<Game>>> {
	...
	public MasterServer(CopyOnWriteArrayList<Server<Game>> serverList) {
		super(serverList, MASTER_PORT);
	}

	public static void startMasterHost() {
		CopyOnWriteArrayList<Server<Game>> serverList = new CopyOnWriteArrayList<>();
